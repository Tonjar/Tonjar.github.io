...
function level(x){
    ...
    if(Hash(getCookie("UserName")+"_"+getCookie("UserEmail")+"_"+getCookie("UserPassword")+x)=="mfawpkjmgyhriokz")return 2;
    if(Hash(getCookie("UserName")+"_"+getCookie("UserPassword")+x)=="wvfpnuxthzkzomzy")return 1;
    return 0;
}
